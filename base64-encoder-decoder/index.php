...
if(isset($_POST['btn_encode'])){
    ...
    $result = base64_encode($u_input);
}

if(isset($_POST['btn_decode'])){
    $u_input = htmlspecialchars($_POST['u_input']);
    $result = base64_decode($u_input);
}
...
?>
            ...
            <div class="row no-margins">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" id="u_input" name="u_input" rows="15" placeholder="Paste Base64 Encode/Decode Code here.." required><?=$u_input?></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    ...
                    <h3 class="mb-1 mt-1">BASE64 ENCODER / DECODER</h3>
                    </div>
                    <div class="form-group">
    ...
    <?php include('content/base64.php')?>

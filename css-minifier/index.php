...
if(isset($_POST['btn_submit'])){
    ...
    $result = htmlspecialchars(minify_css($_POST['u_input'])); 
}
                    ...
                    <div class="box">
                        <div class="row">
                            <div class="col-lg-6 text-center-lg">
                                <h2 class="mb-0">CSS MINIFIER</h2>
                            </div>
                            <div class="col-lg-6 text-right text-center-lg">
                                <input type="submit" class="btn btn-primary btn-round mb-1" name="btn_submit" value="MINIFY CSS"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" id="u_input" name="u_input" rows="15" placeholder="Paste CSS here.." required><?=$u_input?></textarea>
                    </div>
                    <div class="form-group">
